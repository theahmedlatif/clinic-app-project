                ...
                <div class="card-body table-responsive-sm">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                {{ $appointment->patient->user->first_name.' '.$appointment->patient->user->middle_name.' '.$appointment->patient->user->last_name}}
                            </td>
                            <td>{{$appointment->status->status_name}}</td>
                            <td>
                                <a href="{{route('doctor.view.visit',$appointment->id)}}" class="btn btn-outline-dark btn-sm">Start Visit</a>


                                @if(\Illuminate\Support\Facades\Route::currentRouteName() == 'doctor.view.myReservedVisits')
